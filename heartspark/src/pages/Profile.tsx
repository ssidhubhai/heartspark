...
export function Profile() {
  ...
  if (loadingProfile) {
    return (
      <div className="max-w-2xl mx-auto w-full bg-white dark:bg-[#0A0A0A] min-h-screen border-x border-zinc-100 dark:border-zinc-900 shadow-sm pb-20 animate-pulse">
