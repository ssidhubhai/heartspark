    ...
    <AnimatePresence>
      {showPrompt && (
        <motion.div
          ...
          className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-96 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl rounded-2xl shadow-xl border border-pink-100 dark:border-pink-900/30 p-4 z-50 flex items-start gap-4"
        >
