      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-zinc-900/50 backdrop-blur-sm">
          <motion.div
            ...
            className="bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl rounded-2xl shadow-xl w-full max-w-md overflow-hidden relative border border-pink-100 dark:border-pink-900/30"
          >
            <button
              onClick={onClose}
              className="absolute top-4 right-4 p-2 text-zinc-400 hover:text-zinc-600 dark:hover:text-zinc-200 rounded-full hover:bg-pink-50 dark:hover:bg-zinc-800 transition-colors"
            >
              <X className="w-5 h-5" />
            </button>
              ...
              {isForgotPassword ? (
                ...
                <>
                  <div className="mt-6 flex items-center gap-4">
                    <div className="h-px bg-pink-100 dark:bg-zinc-800 flex-1"></div>
                  ...
                  <Button
                    ...
                    className="w-full mt-6 flex items-center justify-center gap-2 border-pink-200 dark:border-zinc-700 hover:bg-pink-50 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300"
                    disabled={loading}
                  >
